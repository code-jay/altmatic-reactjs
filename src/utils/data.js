...
export const ourCourses = [
  {
    ...
    tickmark: "/OurDiff/check-mark.png",
    title: "Python & Django Full Stack",
    duration: "- 3 months | 1 Capstone Project",
    livesession: "- 1-on-1 Live Doubt Session",
  ...
  },
  {
    ...
    duration: "- 1 month | 1 Capstone Project",
    livesession: "- 1-on-1 Live Doubt Session",
...
export const ourCourse2 = [
  {
    icon: "/howItWorks/Frame-0.png",
    tickmark: "/OurDiff/check-mark.png",
    title: "PHP & Laravel 11 Full Stack",
    duration: "- 3 months | 1 Capstone Project",
    livesession: "- 1-on-1 Live Doubt Session",
